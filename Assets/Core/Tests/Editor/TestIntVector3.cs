...
{
	[TestFixture]
	public class TestIntVector3
	{
		[Test]
		public void Add()
		{
			var a = new IntVector3( 1, 1, 1 );
			var b = new IntVector3( 2, 2, 2 );
			var c = a + b;
		...
		{
			var a = new IntVector3( 2, 2, 2 );
			var b = new IntVector3( 3, 3, 3 );
			var c = a * b;
		...
		{
			var a = new IntVector3( 1, 2, 0 );
			var b = new Vector2( 1, 2 );
			
			Assert.IsTrue( a == b.ToIntVector3() );
		}
